...
export default function SettingsModal({
  ...
  onLinkAccount,
  myAccountCode = null,
  // Google account linking (signed-in user → connect Google for future logins)
  googleLinked = false,
  googleLinkedEmail = "",
  onLinkGoogle = null,
  onUnlinkGoogle = null,
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              {/* ── Google sign-in link ── */}
              {typeof onLinkGoogle === "function" && myAccountCode && myAccountCode !== "guest" && (
                <div style={{ marginTop: 10, borderTop: "1px solid rgba(var(--border-rgb),0.12)", paddingTop: 4 }}>
                  <Section title={T("Sign-in methods", "طرق تسجيل الدخول")} />
                  <div
                    style={{
                      margin: "4px 8px 10px",
                      padding: "12px 12px",
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: 11.5, color: "var(--muted)", marginTop: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                          {googleLinked
                            ? (googleLinkedEmail
                                ? T(`Linked · ${googleLinkedEmail}`, `مربوط · ${googleLinkedEmail}`)
                                : T("Linked", "مربوط"))
                            : T("Not linked — sign in faster next time", "غير مربوط — سجّل أسرع لاحقاً")}
                        </div>
                      </div>
                    </div>
                    {googleLinked ? (
                      <button
                        ...
                        style={{
                          ...
                          opacity: googleLinkBusy ? 0.6 : 1,
                        }}
                      >
                        {googleLinkBusy
                          ? T("Working…", "جارٍ…")
                          : T("Unlink Google", "إلغاء ربط Google")}
                      </button>
                    ) : (
                      <button
                        type="button"
                      ...
                      >
                        {googleLinkBusy
                          ...
                          : T("Link Google account", "ربط حساب Google")}
                      </button>
                    )}
                  </div>
                </div>
