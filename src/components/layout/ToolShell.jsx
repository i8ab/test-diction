...
import { TimerPage, CalendarPage, TodoPage, GoalsPage, SchedulePage, LanguageNotesPage, DayAchievementsModal } from "../modals/lazyModals";
      ...
      {showSchedule && (
        <Suspense fallback={paperFallback}>
          <SchedulePage
            isAr={appIsAr}
            accountCode={accountCode || ""}
            initialBubble={scheduleBubble}
            onClose={closeSchedule}
            onBubbleChange={setScheduleBubble}
          />
        </Suspense>
      )}
