...
import {
  ...
  MicIcon, StarIcon, WandIcon, MoreIcon, BookIcon, MoonIcon,
  QuranIcon, DuaIcon, HeartIcon, TargetIcon, MedalIcon, ListChecksIcon,
  ...
  const categories = [
    {
      ...
      items: [
        ...
        ...(typeof onSmartCards === "function"
          ? [{ key: "smartCards", icon: <SparklesIcon size={18} />, tint: "#ff9f0a", label: tr(isAr, "Smart cards", "بطاقات ذكية"), onClick: onSmartCards }]
          : []),
        ...
        ...(typeof onSentencePractice === "function"
          ? [{ key: "sentence", icon: <PenLineIcon size={18} />, tint: "#32ade6", label: tr(isAr, "Sentence practice", "تمرين الجمل"), onClick: onSentencePractice }]
          : []),
        { key: "quiz", icon: <QuizIcon size={18} />, tint: "#af52de", label: tr(isAr, "Quiz", "اختبار"), onClick: onQuiz },
        { key: "exam", icon: <FileTextIcon size={18} />, tint: "#e85d04", label: tr(isAr, "Exam Mode", "وضع الامتحان"), onClick: onExamMode },
        { key: "random", icon: <ShuffleIcon size={18} />, tint: "#7b2cbf", label: tr(isAr, "Random word", "كلمة عشوائية"), onClick: onRandomWord },
      ],
    },
    {
      id: "mindset",
      ...
      items: [
        ...(typeof onMotivationDua === "function"
          ? [{
              key: "motivationDua",
              icon: <QuranIcon size={18} />, tint: "#b45309",
    ...
    },
    {
      ...
      items: [
        { key: "dashboard", icon: <GaugeIcon size={18} />, tint: "#5b8def", label: tr(isAr, "Dashboard", "لوحة القيادة"), onClick: onDashboard },
        { key: "stats", icon: <StatsIcon size={18} />, tint: "#5b8def", label: tr(isAr, "Stats", "إحصائياتي"), onClick: onStats },
        ...(typeof onWeeklyReport === "function"
          ? [{ key: "weekly", icon: <ReportIcon size={18} />, tint: "#30d158", label: tr(isAr, "Weekly report", "التقرير الأسبوعي"), onClick: onWeeklyReport }]
          : []),
        { key: "achievements", icon: <MedalIcon size={18} />, tint: "#f4a261", label: tr(isAr, "Achievements", "الإنجازات"), onClick: onAchievements },
        { key: "goals", icon: <TargetIcon size={18} />, tint: "#ff9f0a", label: tr(isAr, "Goals", "الأهداف"), onClick: onGoals },
        ...
        ...(typeof onLevels === "function"
          ? [{ key: "levels", icon: <StarIcon size={18} />, tint: "#f5c542", label: tr(isAr, "Levels & XP", "المستويات والنقاط"), onClick: onLevels }]
          : []),
        ...(typeof onProgressCompare === "function"
          ? [{ key: "compare", icon: <HistoryIcon size={18} />, tint: "#5b8def", label: tr(isAr, "You vs past you", "أنت ونفسك القديمة"), onClick: onProgressCompare }]
          : []),
      ],
    },
    {
      ...
      items: [
        ...
        ...(typeof onConversation === "function"
          ? [{ key: "conversation", icon: <MessageIcon size={18} />, tint: "#5e5ce6", label: tr(isAr, "Conversation", "محادثة"), onClick: onConversation }]
          : []),
        ...(typeof onTutorChat === "function"
          ? [{ key: "tutorChat", icon: <HeartIcon size={18} />, tint: "#5b8def", label: tr(isAr, "Study Coach", "مساعد الدراسة"), onClick: onTutorChat }]
          : []),
        ...(typeof onTextExtract === "function"
          ? [{ key: "extract", icon: <ScanTextIcon size={18} />, tint: "#ff2d55", label: tr(isAr, "Extract from text", "استخراج من نص"), onClick: onTextExtract }]
          : []),
