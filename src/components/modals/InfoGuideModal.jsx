...
const GUIDES = [
  ...
  { id: "settings", titleEn: "Settings & account", titleAr: "الإعدادات والحساب",
    whatEn: "Appearance (logo, theme, density, colors), language, accent, profile.", whatAr: "المظهر (الشعار، الوضع، الكثافة، الألوان)، اللغة، اللهجة، والحساب.",
    stepsEn: [
      "☰ → Settings.",
      "Appearance: change logo mark, light/dark, list density, modal corners, color theme.",
      "Language, English accent (Cambridge), notifications.",
      "Avatar in header opens My account.",
    ],
    stepsAr: [
      "☰ → إعدادات.",
      "المظهر: تغيير شعار الموقع، فاتح/داكن، كثافة القائمة، دائرية النوافذ، لون الواجهة.",
      "اللغة، لهجة الإنجليزية (كامبريدج)، الإشعارات.",
      "الأفاتار في الهيدر يفتح حسابي.",
    ] },
