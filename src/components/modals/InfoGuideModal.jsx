...
const GUIDES = [
  ...
  { id: "focus", titleEn: "Focus mode", titleAr: "وضع التركيز",
    ...
    stepsEn: ["More ⋯ → Focus mode, or press F.", "Escape exits focus mode (or press F again)."],
    stepsAr: ["المزيد ⋯ → وضع التركيز، أو F.", "Escape يخرج من وضع التركيز (أو F تاني)."] },
  ...
  { id: "mobile", titleEn: "Mobile app layout", titleAr: "واجهة الموبايل",
    ...
    stepsEn: [
      ...
      "Focus mode (More ⋯ or F) hides banners and the bottom bar for distraction-free study.",
    ...
    stepsAr: [
      ...
      "وضع التركيز (المزيد ⋯ أو F) يخفي البانرات والشريط السفلي للمذاكرة بهدوء.",
  ...
  { id: "tablet", titleEn: "Tablet layout", titleAr: "واجهة التابلت",
    ...
    stepsEn: [
      ...
      "Focus mode (More ⋯ or F) hides the side dock for quiet study.",
    ...
    stepsAr: [
      ...
      "وضع التركيز (المزيد ⋯ أو F) يخفي الشريط الجانبي للمذاكرة بهدوء.",
