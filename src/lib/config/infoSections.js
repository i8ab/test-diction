import {
  BookIcon, CheckIcon, FlameIcon, LayersIcon, MicIcon, QuizIcon, StarIcon,
...
export const INFO_SECTIONS = [
  ...
  },
  {
    ...
    bodyEn: [
      ...
      "Leaderboard, offline cache, CSV/Anki export, site language in Settings.",
    ...
    bodyAr: [
      ...
      "لوحة الصدارة، كاش أوفلاين، تصدير CSV/Anki، لغة الموقع من الإعدادات.",
